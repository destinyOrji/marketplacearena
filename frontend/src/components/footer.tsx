                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center mb-6">
                            ...
                            />
                            <span className="text-xl font-semibold">MarketPlace Health</span>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="text-blue-100">support@marketplacehealth.ng</span>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="text-blue-100">Victoria Island, Lagos, Nigeria</span>
                            </div>
                        </div>
