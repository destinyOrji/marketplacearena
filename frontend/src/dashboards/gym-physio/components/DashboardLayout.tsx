                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden z-50">
                    ...
                    {notifications.length > 0 && (
                      <div className="px-4 py-3 border-t border-gray-200 bg-gray-50">
                        <button
                          onClick={() => {
                            navigate('/gym-physio/notifications');
                            setShowNotifications(false);
                          }}
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden z-50">
                    <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
                      ...
                      <p className="text-xs text-gray-500 capitalize">
                        {gymPhysio?.businessType || 'Gym / Physio'}
                      </p>
                    </div>
                    <div className="py-1">
                      <button
                        onClick={() => { navigate('/gym-physio/profile'); setShowProfileMenu(false); }}
                      ...
                      <button
                        onClick={() => { navigate('/gym-physio/settings'); setShowProfileMenu(false); }}
                        className="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2"
                      >
                        <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
